...
namespace Adberration
{
    ...
    internal static class PropertySerializer
    {
        ...
        internal static void SetValue(PropertyInfo propertyInfo, Entity entity, string? value)
        {
            ...
            {
                propertyInfo.SetValue(entity, value == null ? Sprite.DefaultColor : DataConvert.ToColor(value));
                return;
            }
            ...
            {
                propertyInfo.SetValue(entity, value == null ? null : DataConvert.ToPolygon(value));
                return;
            }
            ...
            {
                propertyInfo.SetValue(entity, value == null ? Rectangle.Empty : DataConvert.ToRectangle(value));
                return;
            }
            ...
            {
                propertyInfo.SetValue(entity, value == null ? RectangleF.Empty : DataConvert.ToRectangleF(value));
                return;
            }
            ...
            {
                propertyInfo.SetValue(entity, value == null ? Size.Empty : DataConvert.ToSize(value));
                return;
            }
            ...
            {
                propertyInfo.SetValue(entity, value == null ? Vector2.Zero : DataConvert.ToVector2(value));
                return;
            }
        }
        ...
        internal static void Serialize(PersistentProperty persistentProperty, object obj, XmlWriter output)
        {
            ...
            if (propertyInfo.PropertyType == typeof(Color))
            {
                if (propValue is Color value)
                    output.WriteAttributeString(storageName, DataConvert.ToString(value));
            ...
            if (propertyInfo.PropertyType == typeof(Polygon))
            {
                if (propValue is Polygon polygon)
                    output.WriteAttributeString(storageName, DataConvert.ToString(polygon));
