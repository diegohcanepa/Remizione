...
namespace Engendro
{
    ...
    public sealed class Polygon
    {
        ...
        // Inflate (Optimized with ChatGPT)
        ...
        // SetVertices
        public void SetVertices(Span<Vector2> vertices) => SetVertices(vertices, 0);

        // SetVertices
        public void SetVertices(Span<Vector2> vertices, float inflate)
        {
            if (ReadOnly)
                throw new InvalidOperationException("Cannot modify a read-only polygon.");
