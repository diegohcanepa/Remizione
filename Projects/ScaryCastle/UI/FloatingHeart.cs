...
namespace ScaryCastle
{
    ...
    public sealed class FloatingHeart : GameObject
    {
        ...
        public void Show(Vector2 origin, bool half)
        {
            ...
            image.Image = half ? Atlases.UI.HeartHalf : Atlases.UI.HeartFull;
            ...
            scaleTween.Start(TweenStyle.Linear, ScaleInfo.UIElement.VeryTiny, ScaleInfo.UIElement.Medium, Random.Shared.Next(100, 300));
