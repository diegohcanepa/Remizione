...
namespace ScaryCastle
{
    ...
    /// ItemWheelScene
    /// </summary>
    public abstract class ItemWheelScene : Scene
    {
        ...
        // Constructor
        protected ItemWheelScene(GameSession session)
            : base(session.Game)
        {
        ...
        */
        ...
        private void Select(int index)
        {
            ...
            {
                itemNameText.Text = visualItems[index].MetaItem.LocalizedDisplayName;
                OnSelect(visualItems[index]);
            }
        ...
        protected override HandleInputResult OnHandleInput(GameTime gameTime)
        {
            ...
            {
                var itemName = SelectedItem?.MetaItem.Name;
                SceneController.Pop();
        ...
        // OnInvalidateSlot
        protected virtual void OnInvalidateSlot()
        {
        }

        // OnSelect
        protected virtual void OnSelect(VisualItem item)
        {
        }
        ...
        // OnUse
        protected virtual void OnUse(VisualItem item)
        {
        }

        // SelectedItem
        protected VisualItem? SelectedItem => selectedIndex == -1 ? null : visualItems[selectedIndex];
        ...
        public sealed class VisualItem : GameObject
        {
            ...
            // Constructor
            public VisualItem(ScaryCastleGame game, MetaItem metaItem)
                : base(game)
            {
                this.MetaItem = metaItem;

                // Image
                this.image = new(Game, metaItem.Image)
                {
                    PivotOrigin = RectanglePoint.Center
                };
            }
