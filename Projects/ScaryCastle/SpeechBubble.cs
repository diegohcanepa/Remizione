...
namespace ScaryCastle
{
    ...
    public sealed class SpeechBubble : GameObject
    {
        ...
        private void DrawBubble(GameTime gameTime)
        {
            ...
            // Draw bubble shadow
            bubbleImage.Color = ColorPalette.SpeechBubble.Shadow;
            bubbleImage2.Color = ColorPalette.SpeechBubble.Shadow;
            ...
            // Draw bubble
            bubbleImage.Color = ColorPalette.SpeechBubble.Fill;
            bubbleImage2.Color = ColorPalette.SpeechBubble.Fill;
            bubbleImage2.Draw(gameTime);
            bubbleImage.Draw(gameTime);
        ...
        public void Show(string title, string text, bool awaitInput)
        {
            ...
            if (SpeechBubbleSettings.TextTyping && awaitInput)
            {
                if (SpeechBubbleSettings.TextTypingSound)
                    this.text.StartTyping(Actor.SpeechBubbleSound?.PopInstance());
                else
