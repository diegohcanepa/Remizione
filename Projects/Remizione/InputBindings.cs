...
namespace Remizione
{
    ...
    internal static class InputBindings
    {
        ...
        internal static readonly InputBinding Discard = InputManager.AddBinding(nameof(Discard), Buttons.X, Keys.D);
        ...
        internal static readonly InputBinding ViewAll = InputManager.AddBinding(nameof(ViewAll), Buttons.Y, Keys.I);
