...
namespace Remizione
{
    ...
    internal static class InputBindings
    {
        ...
        internal static readonly InputBinding PauseMenu = InputManager.AddBinding(nameof(PauseMenu), Buttons.Start, Keys.Escape);
        ...
        internal static readonly InputBinding Interact = InputManager.AddBinding(nameof(Interact), Buttons.Y, MouseButton.Left, Keys.E, Keys.Enter);
