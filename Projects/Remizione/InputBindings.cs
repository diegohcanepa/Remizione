...
namespace Remizione
{
    ...
    internal static class InputBindings
    {
        ...
        internal static readonly InputBinding UseLeftJunkItem = InputManager.AddBinding(nameof(UseLeftJunkItem), Buttons.X, Keys.Z);
        internal static readonly InputBinding UseRightJunkItem = InputManager.AddBinding(nameof(UseRightJunkItem), Buttons.B, Keys.X);
