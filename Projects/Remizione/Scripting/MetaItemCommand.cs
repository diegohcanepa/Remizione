...
namespace Remizione.Scripting
{
    ...
    internal sealed class MetaItemCommand : NonAwaitableCommand
    {
        ...
        internal MetaItemCommand(Script script, string source, StatementBody body)
            : base(script, source, body, 2, ActionArg, AllowEmptyArg, CriticalChanceArg, DamageArg, DamageKindArg, DurabilityArg, HealthArg, ImpactWordArg, KnockbackArg, MaximumArg, PassiveEffectCooldownArg, PowerArg, PreventDiscardArg, RangeArg, ReplenishPerRoomArg, SkillChanceArg, SoundArg)
        {
            ...
            _ = new MetaItem(name, category, maximum)
            {
                ...
                Power = Parser.ParseInt32Argument(this, PowerArg, 0),
