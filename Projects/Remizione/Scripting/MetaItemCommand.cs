...
namespace Remizione.Scripting
{
    ...
    internal sealed class MetaItemCommand : NonAwaitableCommand
    {
        ...
        internal MetaItemCommand(Script script, string source, StatementBody body)
            : base(script, source, body, 2, AllowEmptyArg, BonusArg, CraftArg, DamageArg, DurabilityArg, FaithArg, HPArg, KnockbackArg, MaximumArg, ModifierArg, PassiveEffectCooldownArg, RangeArg, SoundArg, ThrowableArg)
        {
            ...
            _ = new MetaItem(name, category, maximum)
            {
                ...
                IsThrowable = HasArg(ThrowableArg),
