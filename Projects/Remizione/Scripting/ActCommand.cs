...
namespace Remizione.Scripting
{
    ...
    internal sealed class ActCommand : AwaitableCommand
    {
        private Actor? actor;
        private SpriteAnimation? animation;

        // Constructor
        internal ActCommand(Script script, string source, StatementBody body)
        ...
        protected override void OnExecute()
        {
            ...
            animation = actor.Act(animationName, HasArg(LoopedArg), direction, HasArg(PreserveArg));
        }
