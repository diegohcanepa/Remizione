...
namespace Remizione.Scenes
{
    ...
    /// InventoryScene
    /// </summary>
    internal sealed class OldInventoryScene : Scene
    {
        ...
        // Constructor
        public OldInventoryScene(GameSession session)
            : base(session.Game, SceneSettings.PausePreviousScenes | SceneSettings.ExclusiveDraw)
        {
            ...
            {
                Color = ColorPalette.TextDepracated.Green,
        ...
        private void InvalidateItemInfo()
        {
            ...
            if (ActiveGrid?.SelectedSlot?.Item is Item item)
            {
                ...
                itemActionButton.TextColor = ColorPalette.Text.Default;
