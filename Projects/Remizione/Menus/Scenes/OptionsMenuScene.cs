...
namespace Remizione.Menus
{
    ...
    public sealed partial class OptionsMenuScene : StandardMenuScene
    {
        ...
        {
            this.mouseInfo = new TextSprite(game, Fonts.Regular) { Scale = ScaleInfo.Text.Medium, Color = Color.White, PivotOrigin = RectanglePoint.LeftTop };
            ...
            */
            ...
            // Option description
            this.optionDescription = new TextSprite(game, Fonts.Regular)
            {
