...
namespace Microsoft.Xna.Framework.Content.Pipeline.Processors
{
    ...
    class LocalizedFontTextureImporter : TextureImporter
    {
        public override TextureContent Import(string filename,  ContentImporterContext context)
        {
            ...
            string allChars = File.ReadAllText(textFileName, Encoding.UTF8);
    ...
    public class LocalizedFontTextureProcessor : FontTextureProcessor
    {
        ...
        // Constructor
        public LocalizedFontTextureProcessor()
            : base()
        {
            DefaultCharacter = '?';
        }
        ...
        /// <returns></returns>
        protected override char GetCharacterForIndex(int index) => allCharacters[index];
