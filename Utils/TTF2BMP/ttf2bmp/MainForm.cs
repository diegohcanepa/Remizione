...
namespace TrueTypeConverter
{
    ...
    {
        readonly Bitmap globalBitmap;
        readonly Graphics globalGraphics;
        Font font;
        string fontError;
        ...
        public MainForm()
        {
            ...
            VerticalOffset.Text = Properties.Settings.Default.VerticalOffset;
            ExtraHeight.Text = Properties.Settings.Default.ExtraHeight;
            ...
            try
            {
                ...
                if (fileSelector.ShowDialog() == DialogResult.OK)
                {
                    ...
                    try
                    {
                        ...
                        // Rasterize each character in turn and add it to the output list.
        ...
        {
            var extraHeight = int.Parse(ExtraHeight.Text);
            string text = ch.ToString();

            SizeF size = globalGraphics.MeasureString(text, font);

            int width = (int)Math.Ceiling(size.Width);
            int height = (int)Math.Ceiling(size.Height + extraHeight);
            ...
            using (Graphics graphics = Graphics.FromImage(bitmap))
            {
                ...
                using (StringFormat format = new())
                {
                    ...
                    int vOffset = int.Parse(VerticalOffset.Text);
                    ...
                    graphics.DrawString(text, font, brush, 0, vOffset, format);
                }
        ...
        private void MainForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            Properties.Settings.Default.VerticalOffset = VerticalOffset.Text;
            Properties.Settings.Default.ExtraHeight = ExtraHeight.Text;
